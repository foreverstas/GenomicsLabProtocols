...
-   Иммунопреципитация хроматина: оптимизация, количественный анализ и нормализация данных [Haring et al. 2007](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2077865/).
