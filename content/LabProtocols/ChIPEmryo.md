...
-   *Я выделил ДНК. Достаточно ли ее для пробоподготовки?*
...
Как правило, при изучении транскрипционных факторов, на одну иммунопреципитацию берут не мене 50 мкг ДНК (фиксированного хроматина). Для гистонов или белков, обладающих широким распространением по геному, количество стартового материала в 7-10 раз ниже.

Количество антител для иммунопреципитации определяется их качеством. Хорошие антитела обладают отличной емкостью (сотни нанограмм ДНК на мкг антител). В большинстве случаях выход сильно ниже. Тогда нужно добавить больше антител. Однако, если суммарная емкость антител превышает количество метки в образце, то это приводит к увеличению неспецифичных сигналов в qPCR и, в конечном итоге, в итоговом профиле ChIP-seq. Желательно провести предварительный эксперимент для определения правильного соотношения антител к хроматину.
